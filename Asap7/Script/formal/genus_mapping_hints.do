...
# Generated on: Thu Jun 11 16:19:43 +07 2026 (Thu Jun 11 09:19:43 UTC 2026)
...
read_implementation_information fv/Mul32 -golden fv_map -revised Mul32_synv
...
add_search_path ../tkvm/asap7/asap7sc7p5t_28/LIB/CCS -library -both
read_library -liberty -both \
    /home/tkvm3/layout_asap7/../tkvm/asap7/asap7sc7p5t_28/LIB/CCS/asap7sc7p5t_SIMPLE_RVT_TT_ccs_211120.lib \
    /home/tkvm3/layout_asap7/../tkvm/asap7/asap7sc7p5t_28/LIB/CCS/asap7sc7p5t_INVBUF_RVT_TT_ccs_220122.lib \
    /home/tkvm3/layout_asap7/../tkvm/asap7/asap7sc7p5t_28/LIB/CCS/asap7sc7p5t_AO_RVT_TT_ccs_211120.lib \
    /home/tkvm3/layout_asap7/../tkvm/asap7/asap7sc7p5t_28/LIB/CCS/asap7sc7p5t_OA_RVT_TT_ccs_211120.lib \
    /home/tkvm3/layout_asap7/../tkvm/asap7/asap7sc7p5t_28/LIB/CCS/asap7sc7p5t_SEQ_RVT_TT_ccs_220123.lib \
    /home/tkvm3/layout_asap7/../tkvm/asap7/asap7sc7p5t_28/LIB/CCS/asap7sc7p5t_SIMPLE_LVT_TT_ccs_211120.lib \
    /home/tkvm3/layout_asap7/../tkvm/asap7/asap7sc7p5t_28/LIB/CCS/asap7sc7p5t_INVBUF_LVT_TT_ccs_220122.lib \
    /home/tkvm3/layout_asap7/../tkvm/asap7/asap7sc7p5t_28/LIB/CCS/asap7sc7p5t_AO_LVT_TT_ccs_211120.lib \
    /home/tkvm3/layout_asap7/../tkvm/asap7/asap7sc7p5t_28/LIB/CCS/asap7sc7p5t_OA_LVT_TT_ccs_211120.lib \
    /home/tkvm3/layout_asap7/../tkvm/asap7/asap7sc7p5t_28/LIB/CCS/asap7sc7p5t_SEQ_LVT_TT_ccs_220123.lib

read_design -verilog95   -golden -lastmod -noelab fv/Mul32/fv_map.v.gz
elaborate_design -golden -root {Mul32}

read_design -verilog95   -revised -lastmod -noelab ./outputs/Mul32_syn.v
elaborate_design -revised -root {Mul32}

#add_name_alias fv/Mul32/fv_map.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/Mul32/Mul32_synv.singlebit.original_name.alias.json.gz -revised
...
write_compared_points noneq.compared_points.Mul32.fv_map.Mul32_synv.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.Mul32.fv_map.Mul32_synv.rpt
}
report_test_vector -noneq > noneq.test_vector.Mul32.fv_map.Mul32_synv.rpt
...
read_implementation_information fv/Mul32 -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k rtl/Mul32.v
elaborate_design -golden -root {Mul32} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/Mul32/fv_map.v.gz
elaborate_design -revised -root {Mul32}
...
#add_name_alias fv/Mul32/fv_map.singlebit.original_name.alias.json.gz -revised
#set_mapping_method -alias -revised
#add_renaming_rule r1alias _reg((\\\[%w\\\])*(/U\\\$%d)*)$ @1 -type dff dlat -both
...
set_system_mode lec
write_compared_points noneq.compared_points.Mul32.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.Mul32.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.Mul32.rtl.fv_map.rpt
