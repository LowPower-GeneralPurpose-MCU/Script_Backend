...
refinePlace} "explicit legalization immediately after placement optimization"
    ...
    require_contains $flow {verify_core_pg_after_filler_nojog \
    ./verify_rpt/pg_connectivity_after_filler.rpt} "post-filler PG verification without broad reconnect"
