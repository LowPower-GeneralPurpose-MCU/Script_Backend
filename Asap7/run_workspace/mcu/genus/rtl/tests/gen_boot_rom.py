...
se thang.
    ...
    python gen_boot_rom.py <input.mem> <sim_include_dir> [--depth 8192]
...
Boot ROM la 32 KiB (8192 word, cua so 0x0001_0000-0x0001_7FFF).  Anh lon hon
thi script DUNG han thay vi cat bot: phan vuot qua 32 KiB se roi vao vung DECERR.
...
def main():
    ...
    ap.add_argument("--depth", type=int, default=8192, help="MEM_DEPTH cua axi_rom (mac dinh 8192 = 32 KiB)")
    args = ap.parse_args()
