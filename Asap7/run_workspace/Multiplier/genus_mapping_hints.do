...
# Generated on: Sat Jul 11 22:41:14 JST 2026 (Sat Jul 11 13:41:14 UTC 2026)
...
set_verification_information fv_map_Mul32_synv_db

read_implementation_information fv/Multiplier32 -golden fv_map -revised Mul32_synv -use_rtl_names
...
read_design -verilog95   -golden -lastmod -noelab fv/Multiplier32/fv_map.v.gz
elaborate_design -golden -root {Multiplier32}

read_design -verilog95   -revised -lastmod -noelab ./outputs/Mul32_syn.v
elaborate_design -revised -root {Multiplier32}

write_design -golden fv_map_Mul32_synv_db/elab.v -replace
report_design_data
report_black_box
report_modules
...
analyze_extended_mapping fv/Multiplier32/fv_map.map.do fv/Multiplier32/Mul32_synv.map.do -output fv_map_Mul32_synv_1.map.do -input_specification rtl-n1 rtl-n2 -output_specification n1-n2 -replace -verbose
...
set_analyze_option -mapping_file fv_map_Mul32_synv_1.map.do
...
write_compared_points noneq.compared_points.Multiplier32.fv_map.Mul32_synv.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.Multiplier32.fv_map.Mul32_synv.rpt
}
report_test_vector -noneq > noneq.test_vector.Multiplier32.fv_map.Mul32_synv.rpt
...
read_implementation_information fv/Multiplier32 -revised fv_map -use_rtl_names
...
set_mapping_method -search_in_mapping_file
set_analyze_option -mapping_file fv/Multiplier32/fv_map.map.do
check_mapping_setup -mapping_file_quality -summary
