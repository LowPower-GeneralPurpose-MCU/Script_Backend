...
# Generated on: Tue Aug 11 23:40:58 JST 2026 (Tue Aug 11 14:40:58 UTC 2026)
...
set_verification_information fv_map_riscv_pipeline_synv_db

read_implementation_information fv/riscv_pipeline -golden fv_map -revised riscv_pipeline_synv -use_rtl_names
...
read_design -verilog95   -golden -lastmod -noelab fv/riscv_pipeline/fv_map.v.gz
elaborate_design -golden -root {riscv_pipeline}

read_design -verilog95   -revised -lastmod -noelab ./outputs/riscv_pipeline_syn.v
elaborate_design -revised -root {riscv_pipeline}

write_design -golden fv_map_riscv_pipeline_synv_db/elab.v -replace
report_design_data
report_black_box
report_modules
...
analyze_extended_mapping fv/riscv_pipeline/fv_map.map.do fv/riscv_pipeline/riscv_pipeline_synv.map.do -output fv_map_riscv_pipeline_synv_1.map.do -input_specification rtl-n1 rtl-n2 -output_specification n1-n2 -replace -verbose
...
set_analyze_option -mapping_file fv_map_riscv_pipeline_synv_1.map.do
...
write_compared_points noneq.compared_points.riscv_pipeline.fv_map.riscv_pipeline_synv.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.riscv_pipeline.fv_map.riscv_pipeline_synv.rpt
}
report_test_vector -noneq > noneq.test_vector.riscv_pipeline.fv_map.riscv_pipeline_synv.rpt
...
read_implementation_information fv/riscv_pipeline -revised fv_map -use_rtl_names
...
delete_search_path -all -design -golden
add_search_path ./rtl -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k rtl/multiplier_divider_unit.v
# This command is only available with LEC 20.10-p100 or later.
set lec_version_required "20.10100"
if {$lec_version >= $lec_version_required} {
set_hdl_option -extract_macro_constraint
...
delete_search_path -all -design -golden
add_search_path ./rtl -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k rtl/branch_prediction_unit.v
# This command is only available with LEC 20.10-p100 or later.
set lec_version_required "20.10100"
if {$lec_version >= $lec_version_required} {
set_hdl_option -extract_macro_constraint
...
delete_search_path -all -design -golden
add_search_path ./rtl -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k rtl/pipeline_control_unit.v
# This command is only available with LEC 20.10-p100 or later.
set lec_version_required "20.10100"
if {$lec_version >= $lec_version_required} {
set_hdl_option -extract_macro_constraint
...
delete_search_path -all -design -golden
add_search_path ./rtl -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k rtl/pipeline_register.v
# This command is only available with LEC 20.10-p100 or later.
set lec_version_required "20.10100"
if {$lec_version >= $lec_version_required} {
set_hdl_option -extract_macro_constraint
...
delete_search_path -all -design -golden
add_search_path ./rtl -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k rtl/pipeline_stage.v
# This command is only available with LEC 20.10-p100 or later.
set lec_version_required "20.10100"
if {$lec_version >= $lec_version_required} {
set_hdl_option -extract_macro_constraint
...
delete_search_path -all -design -golden
add_search_path ./rtl -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k rtl/riscv_pipeline.v
elaborate_design -golden -root {riscv_pipeline} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/riscv_pipeline/fv_map.v.gz
elaborate_design -revised -root {riscv_pipeline}
...
set_mapping_method -search_in_mapping_file
set_analyze_option -mapping_file fv/riscv_pipeline/fv_map.map.do
check_mapping_setup -mapping_file_quality -summary
...
set_system_mode lec
write_compared_points noneq.compared_points.riscv_pipeline.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.riscv_pipeline.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.riscv_pipeline.rtl.fv_map.rpt
